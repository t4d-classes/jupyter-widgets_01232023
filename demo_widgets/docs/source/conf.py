...
# -*- coding: utf-8 -*-
#
# demo_widgets documentation build configuration file
#
...
_version_py = os.path.join(repo, 'demo_widgets', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'demo_widgetsdoc'
...
latex_documents = [
    (master_doc, 'demo_widgets.tex', 'demo_widgets Documentation',
     'Eric', 'manual'),
]
